...
# Data folder
folder = '/Users/stefanorinaldi/Documents/parametric/chi2/' # CHANGEME
...
# Files
draws_file = folder + 'reconstructed_events/posteriors/posterior_functions_samples.json'
rec_file   = folder + 'reconstructed_events/rec_prob/log_rec_prob_samples.txt'
